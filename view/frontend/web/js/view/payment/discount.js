/**
 * Copy of Magento_SalesRule/js/view/payment/discount with different dependencies
 */
...
define([
    ...
    'Vipps_Checkout/js/action/set-coupon-code',
    'Vipps_Checkout/js/action/cancel-coupon',
    ...
    return Component.extend({
        defaults: {
            template: 'Vipps_Checkout/payment/discount'
        },

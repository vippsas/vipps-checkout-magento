...
For support, email us at [vipps@bluemint.dev](mailto:vipps@bluemint.dev) or [submit an issue](https://github.com/vippsas/vipps-checkout-magento/issues) on GitHub.*
